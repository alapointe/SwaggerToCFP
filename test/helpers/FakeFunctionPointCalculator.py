...
class FakeFunctionPointsCalculator(CalculationSpecificationFileTest):
    movement_types = {
            ...
            'Updates a pet in the store with form data.': {
                DataMovementType.ENTRY: ['Category', 'Order'],
                DataMovementType.READ: [],
                DataMovementType.WRITE: [],
                DataMovementType.EXIT: ['Category', 'Pet', 'Tag', 'Error']
            },
    ...
    fpid1 = "Add a new pet to the store."
    fpid2 = "Create user."
    fpid3 = "Creates list of users with given input array."

    def test_calculate_entry_count(self):
        self.assertEqual(3, self.fpc.calculate_entry_count(self.fpid1))
        self.assertEqual(1, self.fpc.calculate_entry_count(self.fpid2))
        self.assertEqual(1, self.fpc.calculate_entry_count(self.fpid3))           
    ...
    def test_calculate_exit_count(self):
        ...
        self.assertEqual(2, self.fpc.calculate_exit_count(self.fpid2))
        self.assertEqual(2, self.fpc.calculate_exit_count(self.fpid3))
   
    def test_calculate_total_count(self):
        self.assertEqual(7, self.fpc.calculate_total_count(self.fpid1))
        self.assertEqual(3, self.fpc.calculate_total_count(self.fpid2))
        self.assertEqual(3, self.fpc.calculate_total_count(self.fpid3))

    def test_calculate_total_per_spec(self):
        self.assertEqual(68, self.fpc.calculate_total_per_spec(self.movement_types))
