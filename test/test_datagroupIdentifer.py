...
class Test_DataGroupIdentifier(unittest.TestCase):
    ...
    def test_get_parameters_datagroups(self):
        ...
        parameters_datagroups = {
            ...
            'Updates a pet in the store with form data.': ['Order', 'Category', 'Pet'], 
    ...
    def test_get_responses_datagroups(self):
        ...
        expected_responses_datagroups = {'Add a new pet to the store.postpet': ['Category', 'Error', 'Pet', 'Tag'], 'Create user.postuser': ['Error', 'User'], 'Creates list of users with given input array.postcreateWithList': ['Error', 'User'], 'Delete purchase order by identifier.delete{orderId}': ['Error'], 'Delete user resource.delete{username}': ['Error'], 'Deletes a pet.delete{petId}': ['Error'], 'Find pet by ID.get{petId}': ['Category', 'Error', 'Pet', 'Tag'], 'Find purchase order by ID.get{orderId}': ['Error', 'Order'], 'Finds Pets by status.getfindByStatus': ['Category', 'Error', 'Pet', 'Tag'], 'Finds Pets by tags.getfindByTags': ['Category', 'Error', 'Pet', 'Tag'], 'Get user by user name.get{username}': ['Error', 'User'], 'Logs out current logged in user session.getlogout': ['Error'], 'Logs user into the system.getlogin': ['Error'], 'Place an order for a pet.postorder': ['Error', 'Order'], 'Returns pet inventories by status.getinventory': ['Error'], 'Update an existing pet.putpet': ['Category', 'Error', 'Pet', 'Tag'], 'Update user resource.put{username}': ['Error'], 'Updates a pet in the store with form data.post{petId}': ['Category', 'Error', 'Pet', 'Tag'], 'Uploads an image.postuploadImage': ['ApiResponse', 'Error']}
    ...
    def test_get_nested_objects(self):
        ...
        content = 'Pet'
        self.assertEqual(self.dgi.get_nested_objects(content, data_model), expected_objects)
